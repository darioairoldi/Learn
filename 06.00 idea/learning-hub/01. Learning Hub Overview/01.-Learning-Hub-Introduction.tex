...
\item
  \textbf{``Passive consumption''} → \textbf{``Active intelligent
  analysis and development''} The Learning Hub actively processes
  information, into the first creation and also into the development
  iterations. Learning hub assists in organizing information for
  readability, consistency\ldots{} and also in identifying knowledge
...
\tightlist
\item
  \textbf{Information gathering} - Multi-channel automated collection
\item
  \textbf{Information filtering} - AI-powered relevance scoring and
  prioritization
\item
