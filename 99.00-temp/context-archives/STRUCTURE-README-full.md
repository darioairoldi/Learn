...
description: "Structure index for PE context files: tier map, functional category IDs, and stable category-to-file mappings for refactoring-safe references."
scope:
  covers:
...
required_categories:
  ...
  pe-dimension-catalog:
    description: "Review dimension catalog with applicability matrix and dimension groups for selective quality assessment by pe-meta-validator and review prompts"
  pe-type-checklists:
    description: "Per-type structural validation checklists enabling self-contained pe-meta validation without delegating to pe-gra validators"
version: "4.3.0"
...
**File count**: 34 context files + this index
...
| 05.07 | `05.07-pe-meta-dimension-catalog.md` | 27 review dimensions with applicability matrix, dimension groups, cost gradient, handler mapping | `pe-meta-validator`, all `pe-meta-*-review` prompts |
| 05.08 | `05.08-pe-meta-type-checklists.md` | Per-type structural validation checklists with exemplary quality bar — enables self-contained validation | `pe-meta-validator`, `pe-meta-builder` |
...
```markdown
**📖 Complete guidance:** [prompt-engineering context folder](./)
```

Use individual file references only for section-specific links:

```markdown
**See the 7-day rule:** [validation-caching-pattern.md](04.01-validation-caching-pattern.md)
```
...
| `pe-dimension-catalog` | Review dimension catalog with applicability matrix and dimension groups | `05.07-pe-meta-dimension-catalog.md` |
| `pe-type-checklists` | Per-type structural validation checklists for self-contained pe-meta validation | `05.08-pe-meta-type-checklists.md` |
...
| 4.3.0 | 2026-05-15 | Added 05.07-pe-meta-dimension-catalog and 05.08-pe-meta-type-checklists to Tier 5. Added `pe-dimension-catalog` and `pe-type-checklists` categories. Updated file count 32→34. |
