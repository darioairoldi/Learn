...
## Dependency-Map Freshness Discipline (Deterministic-First)

Builder and validator runbooks SHOULD run this deterministic check before semantic validation:

1. Verify local-link integrity across:
- `05.01-artifact-dependency-map.md`
- `STRUCTURE-README.md`
- active pe-meta agent files in `.github/agents/00.09-pe-meta/`
2. Record broken or stale references in the execution log.
3. If stale references are found, repair map/index consistency before A-04 guidance adherence reruns.

Freshness check result contract:
...
| 5.4.0 | 2026-05-21 | Added deterministic dependency-map freshness discipline anchors for runbooks (`05.01`, `STRUCTURE-README`, active pe-meta agents). | System |
