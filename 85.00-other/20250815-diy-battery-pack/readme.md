...
2. [Materials and Equipment](#materials-and-equipment)
   - 2.1 [Battery Cells Specification](#battery-cells-specification)
   - 2.2 [Spot Welder Configuration](#spot-welder-configuration)
   - 2.3 [Tools and Accessories](#tools-and-accessories)
3. [Battery Pack Assembly Process](#battery-pack-assembly-process)
   - 3.1 [Nickel Strip Preparation](#nickel-strip-preparation)
   - 3.2 [Cell Arrangement and Connection](#cell-arrangement-and-connection)
   - 3.3 [Series Connection Welding](#series-connection-welding)
4. [Wiring and Electrical Connections](#wiring-and-electrical-connections)
   - 4.1 [Discharge Wire Installation](#discharge-wire-installation)
   - 4.2 [Balance Connector Wiring](#balance-connector-wiring)
   - 4.3 [Final Connector Assembly](#final-connector-assembly)
5. [Testing and Quality Assurance](#testing-and-quality-assurance)
6. [Future Applications and Scalability](#future-applications-and-scalability)
