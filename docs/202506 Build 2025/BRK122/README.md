...
11. [APPENDIX: Passkeys in Blazor Hybrid and .NET MAUI Applications](#appendix-passkeys-in-blazor-hybrid-and-net-maui-applications)
12. [APPENDIX: .NET 10 Scaffolding Tools - dotnet scaffold Command](#appendix-net-10-scaffolding-tools---dotnet-scaffold-command)
...
5. **[01. Passkey Authentication Information](01.%20Passkey%20Authentication%20Information.md)**
...
6. **[FIDO Alliance - WebAuthn Specification](https://webauthn.io/)**
   - Technical specification for Web Authentication API
   - Essential for understanding passkey implementation details

7. **[Microsoft Identity Platform Documentation](https://docs.microsoft.com/en-us/azure/active-directory/develop/)**
...
8. **[ASP.NET Core Security Best Practices](https://docs.microsoft.com/en-us/aspnet/core/security/)**
   - Security guidelines and best practices
   - Important for implementing the security features discussed

### Performance and Diagnostics

9. **[02. Inside Observability with .net 10](02.%20Inside%20Observability%20with%20.net%2010.md)**
   - Comprehensive guide to observability in .NET 10 and .NET Aspire
   - Detailed explanation of runtime enhancements, metrics collection, and diagnostic tools
   - Implementation patterns for distributed tracing and performance monitoring
...
## APPENDIX: Passkeys in Blazor Hybrid and .NET MAUI Applications
...
## APPENDIX: .NET 10 Scaffolding Tools - `dotnet scaffold` Command
