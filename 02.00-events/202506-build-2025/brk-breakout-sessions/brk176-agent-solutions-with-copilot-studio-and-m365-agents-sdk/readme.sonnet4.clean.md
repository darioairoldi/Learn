...
1. [The Multi-Agent Vision](#the-multi-agent-vision)
2. [Microsoft's Unified Platform](#microsofts-unified-platform)
3. [Copilot Studio Multi-Agent Architecture](#copilot-studio-multi-agent-architecture)
   - 3.1 [Lightweight Specialized Agents](#lightweight-specialized-agents)
   - 3.2 [Connected External Agents](#connected-external-agents)
4. [Live Demonstrations](#live-demonstrations)
   - 4.1 [Balance Information Agent](#balance-information-agent)
   - 4.2 [Lost/Stolen Card Workflow](#loststolen-card-workflow)
   - 4.3 [Cross-Platform Integration](#cross-platform-integration)
5. [Multilingual Capabilities](#multilingual-capabilities)
6. [VS Code Extension](#vs-code-extension)
7. [M365 Agents SDK](#m365-agents-sdk)
   - 7.1 [SDK Architecture](#sdk-architecture)
   - 7.2 [Technical Implementation](#technical-implementation)
