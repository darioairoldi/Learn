...
2. [The AI-Driven Modernization Imperative](#the-ai-driven-modernization-imperative)
   - 2.1 [Microsoft's Three-Bucket Approach](#microsofts-three-bucket-approach)
   - 2.2 [Azure Ecosystem Architecture](#azure-ecosystem-architecture)
   - 2.3 [Application Modernization Definition](#application-modernization-definition)
3. [Cloud-Native Architecture Foundations](#cloud-native-architecture-foundations)
   - 3.1 [Four Pillars of Cloud-Native](#four-pillars-of-cloud-native)
   - 3.2 [Azure Cloud-Native Implementation](#azure-cloud-native-implementation)
4. [App Modernization Guidance Framework](#app-modernization-guidance-framework)
   - 4.1 [Discovery and Assessment](#discovery-and-assessment)
   - 4.2 [Modernization Waves Planning](#modernization-waves-planning)
   - 4.3 [Factory Model Implementation](#factory-model-implementation)
5. [AI-Powered Modernization Tools Demo](#ai-powered-modernization-tools-demo)
   - 5.1 [GitHub Copilot App Modernization Extension](#github-copilot-app-modernization-extension)
   - 5.2 [Java Application Modernization Demo](#java-application-modernization-demo)
6. [Cognition Devin AI Agent Integration](#cognition-devin-ai-agent-integration)
   - 6.1 [AI Development Tools Landscape](#ai-development-tools-landscape)
   - 6.2 [End-to-End Autonomous Workflow](#end-to-end-autonomous-workflow)
   - 6.3 [.NET Modernization with Devin](#net-modernization-with-devin)
7. [Enterprise Case Study: Visma's Modernization](#enterprise-case-study-vismas-modernization)
   - 7.1 [Organization Context and Strategy](#organization-context-and-strategy)
   - 7.2 [Workshop Methodology](#workshop-methodology)
   - 7.3 [Flex HRM Success Story](#flex-hrm-success-story)
8. [Session Wrap-up and Resources](#session-wrap-up-and-resources)
