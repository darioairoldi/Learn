---
title: "Appendix: Google Gemini Prompting Guide Analysis"
...
# Appendix: Google Gemini Prompting Guide Analysis
...
- [✂️ Completion Strategy (Prefilling)](#️-completion-strategy-prefilling)
- [📚 Context and Grounding](#-context-and-grounding)
- [🔀 Breaking Down Complex Prompts](#-breaking-down-complex-prompts)
- [⚙️ Model Parameters](#️-model-parameters)
