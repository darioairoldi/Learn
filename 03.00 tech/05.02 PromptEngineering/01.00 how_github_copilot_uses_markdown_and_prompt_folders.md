...
For comprehensive guidance on structuring agent files, defining personas, configuring tools, and creating handoff workflows, see [How to Structure Content for Copilot Agent Files](./04.00%20how_to_structure_content_for_copilot_agent_files.md).
...
For comprehensive guidance on creating skills, see [How to Structure Content for Copilot Skills](./06.%20how_to_structure_content_for_copilot_skills.md).
...
> 📘 **Building your own MCP server?** See [How to Create MCP Servers for GitHub Copilot](./07.%20how_to_create_mcp_servers_for_copilot.md) for implementation guides in TypeScript, C#, and Python.
...
| **<mark>Repo-level instructions</mark>** (`.github/copilot-instructions.md`) | Supported (requires enabling the “Use Instruction Files” setting) | Supported (requires enabling custom instructions in options) | Not supported prior to 17.10 |
...
| **<mark>Agent Skills</mark>** (`.github/skills/*/SKILL.md`) | **Preview** (v1.107+): Portable, resource-rich workflows with templates, checklists, and scripts. Cross-platform (VS Code, CLI, coding agent). Enable via `chat.useAgentSkills`. See [article 06](06.%20how_to_structure_content_for_copilot_skills.md). | Not currently supported. | Not available |
...
- **[How to Name and Organize Prompt Files](./02.00%20how_to_name_and_organize_prompt_files.md)**  
  *Best practices for organizing GitHub Copilot files in your repository, including naming conventions and folder structure.*

- **[How to Structure Content for Copilot Prompt Files](./03.00%20how_to_structure_content_for_copilot_prompt_files.md)**  
  *Detailed guidance on YAML frontmatter, content structuring, and advanced prompt patterns for effective responses.*

- **[How to Structure Content for Copilot Agent Files](./04.00%20how_to_structure_content_for_copilot_agent_files.md)**  
  *Comprehensive guide to creating custom agents with `.agent.md` files, including personas, tools, and handoff workflows.*

- **[How to Optimize Prompts for Specific Models](./08.00%20how_to_optimize_prompts_for_specific_models.md)**  
