...
For information flow patterns between phases, see the previous article: [How to Manage Information Flow During Prompt Orchestrations](./09.00%20how_to_manage_information_flow_during_prompt_orchestrations.md).
...
**[Validation Caching Pattern](.copilot/context/00.00%20prompt-engineering/05-validation-caching-pattern.md)** 📘 [Internal]  
Repository-specific implementation of the 7-day validation caching pattern using bottom metadata blocks.

**[Tool Composition Guide](.copilot/context/00.00%20prompt-engineering/02-tool-composition-guide.md)** 📘 [Internal]  
Optimization patterns for tool usage including "narrow before wide" and lazy loading strategies.

**[Context Engineering Principles](.copilot/context/00.00%20prompt-engineering/01-context-engineering-principles.md)** 📘 [Internal]  
Token budget guidelines and context window management principles.

## Series Navigation

**Previous**: [How to Manage Information Flow During Prompt Orchestrations](./09.00%20how_to_manage_information_flow_during_prompt_orchestrations.md)  
**Series Index**: [How GitHub Copilot Uses Markdown and Prompt Folders](./01.%20how_github_copilot_uses_markdown_and_prompt_folders.md)
