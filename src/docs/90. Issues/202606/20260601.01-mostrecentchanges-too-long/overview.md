...
The `**Most recent changes (vN, YYYY-MM-DD).**` blockquote that opens every vision document in [self-updating-prompt-engineering/](../../../../../06.00-idea/self-updating-prompt-engineering/) accretes detail every version and quickly becomes unreadable. In [20260531.01-vision.v15.md](../../../../../06.00-idea/self-updating-prompt-engineering/20260531.01-vision.v15.md), this block reached **~440 words across two dense paragraphs** — large enough to push the actual vision content below the fold and to compete with the `## 🎯 The problem` section for the reader's first attention.

The block's purpose is a TLDR for orientation. Its content was effectively duplicating the canonical changelog in the sibling [20260531.01-vision.v15.changelog.md](../../../../../06.00-idea/self-updating-prompt-engineering/20260531.01-vision.v15.changelog.md), defeating the single-source-of-truth principle and inflating the vision document's token footprint.
...
| Field | Value |
|---|---|
| **Affected document** | [20260531.01-vision.v15.md](../../../../../06.00-idea/self-updating-prompt-engineering/20260531.01-vision.v15.md) |
| **Block location** | Immediately before `## 🎯 The problem` |
| **Measured size (before)** | ~440 words across 2 paragraphs |
| **Scope-note size** | ~60 words |
| **Sibling changelog** | [20260531.01-vision.v15.changelog.md](../../../../../06.00-idea/self-updating-prompt-engineering/20260531.01-vision.v15.changelog.md) (carries full history) |
...
1. Open [20260531.01-vision.v15.md](../../../../../06.00-idea/self-updating-prompt-engineering/20260531.01-vision.v15.md) in a Markdown preview.
...
All removed detail was verified to be already present in [20260531.01-vision.v15.changelog.md](../../../../../06.00-idea/self-updating-prompt-engineering/20260531.01-vision.v15.changelog.md) — no information was lost.
