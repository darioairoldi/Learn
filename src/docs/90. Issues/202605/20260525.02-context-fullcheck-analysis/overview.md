...
| D14 | Naming convention | 🟠 DEFERRED | 3 files (`STRUCTURE-CATEGORIES.md`, `STRUCTURE-MAINTENANCE.md`, `STRUCTURE-README.md`) violate kebab-case + numeric-prefix; explicitly deferred in the companion issue (low severity, scoped for a future cycle) |
