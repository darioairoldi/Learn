...
| `06-folder-organization-and-navigation.md` | `diginsight/smartdocs` DynamicNavBuilder / NavRules | External implementation |
| `07-sidebar-menu-rules.md` | `diginsight/smartdocs` DynamicNavBuilder / NavRules | External implementation |
