...
goal: "Guide consumption of PE artifacts from SDK-based applications outside VS Code"
rationales:
  - "SDK consumers have different YAML and billing constraints than editor-based usage"
  - "Bridging PE artifacts to programmatic use extends their value beyond the editor"
