...
The **GitHub Copilot SDK** (public preview since April 2026) brings Copilot's agentic loop to any application. Available for Node.js, Python, Go, and .NET. The critical insight: **the SDK consumes the same files you already write**.
