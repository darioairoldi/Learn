...
goal: "Provide a decision framework for when and how to build multi-agent orchestrations"
rationales:
  - "Multi-agent architectures require clear design principles to avoid over-engineering"
  - "Subagent mechanics and the four-specialist pattern need centralized documentation"
...
- **Sources** (practical examples):
  - [10.00-how_to_design_orchestrator_prompts.md](../../../03.00-tech/05.02-prompt-engineering/04-howto/10.00-how_to_design_orchestrator_prompts.md) — four-specialist pattern, phase-based coordination (linear, iterative, parallel), use case challenge 5-step methodology, execution flow control (iteration limits, recursion prevention, error handling)
  - [11.00-how_to_design_subagent_orchestrations.md](../../../03.00-tech/05.02-prompt-engineering/04-howto/11.00-how_to_design_subagent_orchestrations.md) — subagent mechanics, runSubagent tool patterns, context isolation examples
