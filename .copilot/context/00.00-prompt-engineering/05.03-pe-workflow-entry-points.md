...
| Prompt | Purpose | Mode |
|---|---|---|
| `/pe-meta-update` | Incorporate new guidance (fullcheck) | Read-write |
| `/pe-meta-update healthcheck` | System review by scope+dimension | Read-only |
| `/pe-meta-update performancecheck` | Apply optimizations | Read-write |
