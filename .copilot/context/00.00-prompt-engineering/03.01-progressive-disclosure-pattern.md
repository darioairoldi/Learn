...
goal: "Document the three-level loading system for agent skills that minimizes context consumption"
rationales:
  - "Skills must balance discoverability with token cost"
  - "Progressive loading (discovery → instructions → resources) prevents context bloat"
authoritative_sources:
  - url: "https://code.visualstudio.com/docs/copilot/copilot-customization#_agent-skills"
...
- [06.00-how_to_structure_content_for_copilot_skills.md](../../../03.00-tech/05.02-prompt-engineering/04-howto/06.00-how_to_structure_content_for_copilot_skills.md) — progressive disclosure system examples, complete skill walkthrough (security review), description best practices, resource referencing patterns
