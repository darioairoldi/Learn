...
**Referenced by**: Meta-review prompt (`pe-meta-update healthcheck`), `prompt-design`, `agent-design`, all PE agents and prompts (indirectly via semantic search)
...
1. **Use the right prompt**:
   ...
   - System-wide review: `/pe-meta-update healthcheck` (scope + dimension parameters)
   - Example: `/pe-meta-update healthcheck all coherence+structure+references`
