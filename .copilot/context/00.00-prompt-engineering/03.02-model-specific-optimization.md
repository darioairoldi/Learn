...
| **Claude (Opus 4.7, Sonnet 4)** | XML structure, clear context, CoT for complex tasks |
...
|---|---|---|---|---|
| **Claude (Opus 4.7, Sonnet 4)** | XML-tagged sections (`<instructions>`, `<context>`, `<examples>`) | Critical constraints first, nested XML for complex parts | Place static/reusable content at prompt start — 90% cached-prefix discount | Extended Thinking for complex tasks; set `budget_tokens`, don't micromanage |
