...
goal: "Provide a decision framework for using GitHub Copilot Spaces as persistent cross-project context"
rationales:
  - "Spaces complement repo-level files for cross-project knowledge sharing"
  - "Clear when-to-use guidance prevents misuse or duplication with repo customization files"
