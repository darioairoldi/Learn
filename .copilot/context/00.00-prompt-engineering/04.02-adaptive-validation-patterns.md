...
goal: "Provide challenge-based validation methodology for ensuring prompt goals, roles, and workflows are reliable"
rationales:
  - "Static validation misses edge cases that challenge-based discovery catches"
  - "Complexity assessment drives appropriate validation depth per artifact"
---
