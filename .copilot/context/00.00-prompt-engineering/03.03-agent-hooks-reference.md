...
goal: "Provide a quick reference for lifecycle events, JSON schema, and I/O protocol for agent hooks"
rationales:
  - "Hooks enable deterministic automation at 8 lifecycle points"
  - "Centralized reference prevents scattered or inconsistent hook implementations"
authoritative_sources:
  - url: "https://code.visualstudio.com/docs/copilot/copilot-customization#_agent-hooks"
