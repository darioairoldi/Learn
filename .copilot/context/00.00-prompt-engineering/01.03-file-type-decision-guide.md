...
goal: "Eliminate file-type misplacement errors by providing a flowchart-style decision tree for choosing the correct artifact type"
rationales:
  - "File-type misplacement is a frequent error — a decision guide at Tier 1 catches this before builders create artifacts"
  - "Referenced by copilot-instructions.md as the PE Artifact Map, it serves as the canonical routing table for all creation workflows"
...
| 1.3.0 | 2026-03-19 | Added AGENTS.md vs .agent.md comparison (moved from pe-agents.instructions.md) | System |
