...
goal: "Document the fixed injection order so artifact authors know exactly where their content lands in the final prompt and can avoid layer conflicts"
rationales:
  - "Understanding injection order is prerequisite to writing effective artifacts — without this, authors can't reason about what the model sees"
  - "Enables the rule-precedence-across-layers principle: later-injected content overrides earlier content"
...
**📖 Decision flowchart, design patterns, anti-patterns:** `.github/instructions/pe-prompt-snippets.instructions.md`
...
- **Sources** (practical examples):
  - [01.02-how_copilot_assembles_and_processes_prompts.md](../../../03.00-tech/05.02-prompt-engineering/03-concepts/01.02-how_copilot_assembles_and_processes_prompts.md) — 6-layer system prompt diagram, context rot examples, choosing the right mechanism flowchart
  - [01.03-understanding_prompt_files_instructions_and_context_layers.md](../../../03.00-tech/05.02-prompt-engineering/03-concepts/01.03-understanding_prompt_files_instructions_and_context_layers.md) — injection layer comparison, instruction combination behavior
...
| 1.3.0 | 2026-03-19 | Added Agent Visibility Configuration section (visibility matrix moved from pe-agents.instructions.md) | System |
