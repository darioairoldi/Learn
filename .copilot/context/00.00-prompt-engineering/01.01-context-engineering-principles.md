...
- **Prefer category references for external consumers**: Use category IDs from `STRUCTURE-README.md` when possible; use folder-level refs for broad guidance loads and file-level refs only for section-specific links
