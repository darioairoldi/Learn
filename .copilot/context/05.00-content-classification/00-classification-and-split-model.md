...
scope:
  ...
  excludes:
    ...
    - "Evidence dossier structure for autonomous documentation streams"
...
```text
public repo     src/docs/90. Issues/202608/20260817.01-deployfail/03-incident-b.md
internal peer   src/docs/90. Issues/202608/20260817.01-deployfail/03-incident-b.internal.md
```
...
The four classes below are the whole test. They are deliberately few: a taxonomy an author cannot hold in mind is a taxonomy an author will not apply.
