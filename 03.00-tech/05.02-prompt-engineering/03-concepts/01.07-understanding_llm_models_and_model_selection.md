...
## Multi-model architecture patterns 🏗️
...
- [How to optimize prompts for specific models](../04-howto/08.00-how_to_optimize_prompts_for_specific_models.md) — detailed, actionable optimization techniques per model family
- [How Copilot assembles and processes prompts](./01.02-how_copilot_assembles_and_processes_prompts.md) — understanding context windows and attention patterns
- [Chat modes, Agent HQ, and execution contexts](./01.08-chat_modes_agent_hq_and_execution_contexts.md) — how the `model` field interacts with execution modes
