...
This article explains agents conceptually: what they are, why they exist as a separate mechanism, how invocation and handoff patterns work, and how subagent delegation enables complex multi-step workflows. For the practical how-to of *writing* agent files, see [How to structure content for Copilot agent files](../04-howto/04.00-how-to-structure-content-for-copilot-agent-files.md). For designing orchestration prompts that coordinate agents, see [How to design orchestrator prompts](../04-howto/10.00-how-to-design-orchestrator-prompts.md).

## Table of contents

- [What agents are — and what they're not 🎯](#what-agents-are--and-what-theyre-not)
- [How agents override the identity layer 🏗️](#how-agents-override-the-identity-layer)
...
Recall the [prompt assembly architecture](./01.02-how-copilot-assembles-and-processes-prompts.md): the system prompt is built in six layers, with the agent definition at layer 6 (the final layer). When a custom agent is active, its body content replaces the default identity:
...
For practical guidance on designing orchestrator prompts, see [How to design orchestrator prompts](../04-howto/10.00-how-to-design-orchestrator-prompts.md). For subagent implementation details, see [How to design subagent orchestrations](../04-howto/11.00-how-to-design-subagent-orchestrations.md).
...
- [How to structure content for Copilot agent files](../04-howto/04.00-how-to-structure-content-for-copilot-agent-files.md) — practical guide to writing `.agent.md` files
- [How to design orchestrator prompts](../04-howto/10.00-how-to-design-orchestrator-prompts.md) — designing the coordinator in orchestration patterns
- [How to design subagent orchestrations](../04-howto/11.00-how-to-design-subagent-orchestrations.md) — implementing delegation with `runSubagent`
- [Understanding skills, hooks, and lifecycle automation](./01.05-understanding-skills-hooks-and-lifecycle-automation.md) — complementary mechanisms that extend agent capabilities
...
article_metadata:
  filename: "01.04-understanding-agents-invocation-handoffs-and-subagents.md"
  created: "2026-03-01"
...
cross_references:
  related_articles:
    ...
    - "10.00-how-to-design-orchestrator-prompts.md"
    - "11.00-how-to-design-subagent-orchestrations.md"
