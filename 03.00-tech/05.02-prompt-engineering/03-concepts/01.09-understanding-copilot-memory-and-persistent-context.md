...
- [How Memory fits in the customization stack 🏗️](#how-memory-fits-in-the-customization-stack)
- [Shared memory across surfaces 📊](#shared-memory-across-surfaces)
- [What Memory remembers 📋](#what-memory-remembers)
- [Impact on prompt engineering strategy ⚙️](#impact-on-prompt-engineering-strategy)
...
- [Chat modes, Agent HQ, and execution contexts](./01.08-chat-modes-agent-hq-and-execution-contexts.md) — how Memory interacts with chat modes and execution contexts
- [Understanding prompt files, instructions, and context layers](./01.03-understanding-prompt-files-instructions-and-context-layers.md) — the written customization types that Memory complements
- [How to optimize token consumption](../04-howto/13.00-how-to-optimize-token-consumption-during-prompt-orchestrations.md) — managing context window pressure including Memory content
...
article_metadata:
  filename: "01.09-understanding-copilot-memory-and-persistent-context.md"
  created: "2026-03-07"
