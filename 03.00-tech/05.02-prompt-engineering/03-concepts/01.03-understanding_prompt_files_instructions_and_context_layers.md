...
## How they compose in a single request 🏗️
...
- [How Copilot assembles and processes prompts](./01.02-how_copilot_assembles_and_processes_prompts.md) — understand the assembly architecture these types plug into
- [How to structure content for Copilot prompt files](../04-howto/03.00-how_to_structure_content_for_copilot_prompt_files.md) — practical how-to for writing effective prompt files
- [How to structure content for Copilot instruction files](../04-howto/05.00-how_to_structure_content_for_copilot_instruction_files.md) — practical how-to for writing effective instruction files
