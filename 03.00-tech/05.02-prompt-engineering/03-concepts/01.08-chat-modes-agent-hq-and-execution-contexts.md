...
- [Agent HQ: unified session management 🏗️](#agent-hq-unified-session-management)
- [Execution contexts: local, background, and cloud 🖥️](#execution-contexts-local-background-and-cloud)
...
- [Understanding agents, invocation, handoffs, and subagents](./01.04-understanding-agents-invocation-handoffs-and-subagents.md) — the customization layer that builds on top of these modes
- [How Copilot assembles and processes prompts](./01.02-how-copilot-assembles-and-processes-prompts.md) — how your chat mode and context affect prompt assembly
- [How to design orchestrator prompts](../04-howto/10.00-how-to-design-orchestrator-prompts.md) — advanced workflows that leverage multiple modes and contexts
...
article_metadata:
  filename: "01.08-chat-modes-agent-hq-and-execution-contexts.md"
  created: "2026-03-01"
