...
For information flow patterns between phases, see the previous article: [How to Manage Information Flow During Prompt Orchestrations](./10.00-how_to_manage_information_flow_during_prompt_orchestrations.md).
...
**Previous**: [How to Manage Information Flow During Prompt Orchestrations](./10.00-how_to_manage_information_flow_during_prompt_orchestrations.md)  
...
article_metadata:
  filename: "11.00-how_to_optimize_token_consumption_during_prompt_orchestrations.md"
  created: "2026-01-25"
...
series:
  ...
  position: 11
  previous: "10.00-how_to_manage_information_flow_during_prompt_orchestrations.md"
  
cross_references:
  - path: "./10.00-how_to_manage_information_flow_during_prompt_orchestrations.md"
