...
This article focuses on <mark>**how SDK-based applications consume the same prompt engineering artifacts**</mark> documented throughout this series: prompt files, instruction files, agent definitions, skills, and MCP servers. If you've been following articles 01–10, everything you've learned applies directly to SDK apps.
...
The SDK doesn't introduce a new prompt format. It reuses <mark>`.prompt.md`</mark>, <mark>`.agent.md`</mark>, <mark>`.instructions.md`</mark>, and <mark>`SKILL.md`</mark> files exactly as documented in [articles 01–06](./02-getting-started/01.00-how_github_copilot_uses_markdown_and_prompt_folders.md) of this series.
...
1. Structure follows the Diátaxis framework
...
> **Next in the series:** Articles 14 and 15 will cover testing/iterating on prompts and versioning prompt libraries—topics that become even more critical when prompts are consumed by SDK applications.
...
**[How GitHub Copilot Uses Markdown and Prompt Folders](./02-getting-started/01.00-how_github_copilot_uses_markdown_and_prompt_folders.md)** 📗 [Verified Community]  
...
- **[01. How Copilot Uses Markdown and Prompt Folders](./02-getting-started/01.00-how_github_copilot_uses_markdown_and_prompt_folders.md)** — Overview of all Copilot customization surfaces
...
```yaml
article_metadata:
  filename: "12.00-how_to_use_prompts_with_the_github_copilot_sdk.md"
  type: "how-to"
  word_count: ~2800
...
cross_references:
  series:
    ...
    part: 12
    previous: "./11.00-how_to_optimize_token_consumption_during_prompt_orchestrations.md"
    next: null
  related_articles:
