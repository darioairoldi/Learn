...
> **Parent article:** This appendix provides extended reference material for [How to create a prompt orchestrating multiple agents](20-how-to-create-a-prompt-interacting-with-agents.md). Read the main article first for conceptual foundations.

## Table of contents

- [Real Implementation Case Study 🔍](#real-implementation-case-study)
- [Common Mistakes in Multi-Agent Orchestration ⚠️](#common-mistakes-in-multi-agent-orchestration)
...
---
article_metadata:
  filename: "20.01-appendix-orchestration-case-study-details.md"
