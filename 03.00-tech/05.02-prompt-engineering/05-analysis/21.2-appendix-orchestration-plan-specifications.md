...
> **Companion to**: [Multi-Agent Orchestration Plan V2](21.1-example-prompt-interacting-with-agents-plan.md)
...
---
article_metadata:
  filename: "21.2-appendix-orchestration-plan-specifications.md"
  type: "appendix"
  parent: "21.1-example-prompt-interacting-with-agents-plan.md"
