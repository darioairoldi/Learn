...
description: "Learn model-specific prompting techniques for GPT-4o, Claude Sonnet 4, Claude Opus 4.6, Gemini 2.0, and reasoning models (o3/o4-mini) to maximize AI performance in production environments"
guide_versions:
  openai: "2026-01-20"
...
> **Note:** GitHub Copilot now supports **Auto model selection** which automatically picks the best model for your task. The table below covers models you can manually select when you need specific capabilities. See the [GitHub model comparison page](https://docs.github.com/en/copilot/reference/ai-models/model-comparison) for the latest list.

| Model | Provider | Best For | Context Window | Key Behavior | Prompt Style |
|-------|----------|----------|----------------|--------------|--------------|
| **<mark>GPT-4.1</mark>** | OpenAI | General tasks, code generation | 128K+ | Fast, balanced, highly steerable | Explicit instructions, few-shot examples |
| **<mark>GPT-5 mini</mark>** | OpenAI | General-purpose default | 1M+ | Fast, accurate, multimodal | Precise developer messages, Markdown/XML |
| **<mark>GPT-5.2</mark> / <mark>GPT-5.4</mark>** | OpenAI | Deep reasoning, debugging | 1M+ | Multi-step problem solving | High-level goals, success criteria |
| **<mark>GPT-5.x-Codex</mark>** | OpenAI | Agentic software development | 1M+ | Agentic tasks, tool use | Task-oriented, minimal guidance |
| **<mark>Claude Sonnet 4.0</mark>–<mark>4.6</mark>** | Anthropic | General coding, agent tasks | 200K | Balanced performance, strong reasoning | XML tags, clear context, CoT when needed |
| **<mark>Claude Opus 4.6</mark>–<mark>4.7</mark>** | Anthropic | Frontier agentic tasks | 200K | Highest-capability, sophisticated reasoning | Dense system prompts, detailed instructions |
| **<mark>Claude Haiku 4.5</mark>** | Anthropic | Fast, lightweight tasks | 200K | Quick responses, cost-efficient | Simple, direct prompts |
| **<mark>Claude Extended Thinking</mark>** | Anthropic | Complex STEM, constraint problems | 200K | Deep internal reasoning | High-level instructions, let model think |
| **<mark>Gemini 2.5 Pro</mark>** | Google | Deep reasoning, research | 1M+ | Complex code generation, debugging | Clear structure, few-shot examples |
| **<mark>Gemini 3 Flash</mark>** | Google | Fast tasks, lightweight | 1M+ | Quick responses | Direct prompts |
| **<mark>Gemini 3.1 Pro</mark>** | Google | Advanced reasoning, agentic | 1M+ | High tool precision, edit-test loops | Structured prompts, XML/Markdown |
...
|-----------|-------------------|-----------|
| Main agent orchestration | GPT-5 mini | Fast, balanced, reliable |
| Long document analysis | Claude Sonnet 4.6 | 200K context, strong comprehension |
| Complex reasoning decisions | GPT-5.4 | Deep multi-step reasoning |
| Agentic software development | GPT-5.3-Codex | Optimized for agentic tasks |
| Code generation | GPT-5 mini / Claude Sonnet 4.6 | Fast, accurate code output |
| Multimodal (image + text) | Gemini 3.1 Pro / GPT-5 mini | Strong vision capabilities |
| Evaluation/grading | Claude Opus 4.7 | Nuanced judgment, high accuracy |
...
```
    ...
    └──────────┘        └──────────────┘     └──────────────┘
          ...
          ▼                    ▼                    ▼
    ┌──────────┐        ┌──────────────┐     ┌──────────────┐
    │ GPT-5    │        │ Is task      │     │ Claude       │
    │ mini     │        │ complex?     │     │ Sonnet 4.6   │
    └──────────┘        └──────────────┘     │ or Gemini    │
                               │             └──────────────┘
                    ┌──────────┴──────────┐
                    ▼                     ▼
...
|----------|---------------|----------|
| Production agent orchestration | GPT-5 mini | Claude Sonnet 4.6 |
| Complex multi-step reasoning | GPT-5.4 | Gemini 3.1 Pro |
| Document summarization (long) | Claude Sonnet 4.6 | Gemini 2.5 Pro |
| Code generation | GPT-5.3-Codex | Claude Sonnet 4.6 |
| Content moderation | GPT-5 mini | — |
| Visual reasoning | Gemini 3.1 Pro | GPT-5 mini |
| Mathematical problems | GPT-5.4 | Claude Extended Thinking |
| Agentic planning | o3 | GPT-5 |
| Agentic multi-step workflows | Claude Opus 4.7 | Claude Sonnet 4.6, GPT-5.2-Codex |
| Deep analysis, research | Claude Opus 4.7 | Gemini 3.1 Pro, Claude Extended Thinking |
...
|--------------|---------------------------|
| **GPT (4.1, 5 mini, 5.x-Codex)** | Explicit instructions, few-shot examples, developer messages |
| **Claude (Sonnet, Opus)** | XML structure, clear context, CoT for complex tasks |
| **Gemini (2.5 Pro, 3 Flash, 3.1 Pro)** | Consistent formatting, completion patterns, structured prompts |
| **Reasoning (GPT-5.4, Extended Thinking)** | High-level goals, minimal guidance, trust internal reasoning |
...
- 📘 **[GitHub Copilot AI Model Comparison](https://docs.github.com/en/copilot/reference/ai-models/model-comparison)** `[📘 Official]`
  Comprehensive comparison of all models available in Copilot with task-based recommendations. Updated regularly as new models are added.
...
- **[01. How GitHub Copilot Uses Markdown and Prompt Folders](../01-overview/01.00-the_github_copilot_customization_stack.md)** - BYOK model configuration
...
|----------|----------|----------------|---------------|
| [08.01 OpenAI Prompting Guide Analysis](./08.01-appendix_openai_prompting_guide.md) | OpenAI | GPT-4o, GPT-5, o3, o4-mini | 2026-02-20 |
| [08.02 Anthropic Prompting Guide Analysis](./08.02-appendix_anthropic_prompting_guide.md) | Anthropic | Claude Sonnet 4, Opus 4.6, Extended Thinking | 2026-02-20 |
| [08.03 Google Prompting Guide Analysis](./08.03-appendix_google_prompting_guide.md) | Google | Gemini 2.0, Gemini 3 | 2026-02-20 |
...
cross_references:
  series:
    ...
    next: "./09.00-how_to_use_agent_hooks_for_lifecycle_automation.md"
  related_articles:
...
guide_versions:
  github_model_comparison:
    url: "https://docs.github.com/en/copilot/reference/ai-models/model-comparison"
    last_verified: "2026-04-24"
    note: "Model table and quick reference updated to reflect current Copilot model lineup"
  openai:
  ...
  anthropic:
    ...
    last_verified: "2026-02-20"
    models_covered: "Claude Sonnet 4.0–4.6, Claude Opus 4.6–4.7, Claude Haiku 4.5, Claude Extended Thinking"
  google:
    url: "https://ai.google.dev/gemini-api/docs/prompting-strategies"
    last_verified: "2026-02-20"
    models_covered: "Gemini 2.5 Pro, Gemini 3 Flash, Gemini 3.1 Pro"
```
-->
