...
- [Foundry reasoning-model playbook 🏭](#foundry-reasoning-model-playbook)
...
| **<mark>Claude Opus 4.6</mark>** | Anthropic | Frontier agentic tasks | 200K | Highest-capability Anthropic model, multi-step reasoning | Dense system prompts, detailed instructions |
...
> **Deep Dive:** See [08.01 OpenAI Models Prompting Guide Analysis](./08.01-appendix-openai-prompting-guide.md) for comprehensive GPT optimization techniques.
...
> **Deep Dive:** See [08.02 Claude Models Prompting Guide Analysis](./08.02-appendix-anthropic-prompting-guide.md) for comprehensive Claude optimization techniques.
...
> **Deep Dive:** See [08.03 Gemini Models Prompting Guide Analysis](./08.03-appendix-google-prompting-guide.md) for comprehensive Gemini optimization techniques.
...
## 🏭 Foundry reasoning-model playbook

Use this checklist when you optimize prompts for reasoning models deployed in Azure AI Foundry.

### 1. Structure prompts for reasoning tasks

Use a simple goal-context-constraints-output pattern:

```text
Goal: [what success looks like]
Context: [task background and available data]
Constraints: [format, policy, domain rules, risk boundaries]
Output: [exact response structure]
```

Avoid over-specifying reasoning steps. For reasoning-capable models, clear goals and constraints outperform micromanaged chain-of-thought instructions.

### 2. Apply provider-specific API constraints

- Use `max_completion_tokens` when targeting MAI-Thinking-1 APIs.
- If reasoning state is returned in encrypted form, preserve it unchanged across turns.
- Treat reasoning tokens as part of total token budget, not free overhead.
- Validate supported tool types before rollout (MAI-Thinking-1 currently supports function tools).

### 3. Run benchmark-evaluate-monitor loop before promotion

1. Shortlist models via Foundry benchmark/leaderboard views.
2. Run pre-production evaluation on representative prompts and datasets.
3. Check production telemetry for quality, latency, cost, and safety drift.
4. Promote only when thresholds are met; otherwise reroute or rollback.

### 4. Keep preview controls explicit

If the chosen model is in preview:

- Mark the deployment as non-default for high-impact production workloads.
- Add fallback route to a stable model family.
- Re-run this checklist on every model-version or deployment-tier change.
...
- 📘 **[Deploy and use MAI-Thinking-1 in Microsoft Foundry (preview)](https://learn.microsoft.com/azure/foundry/foundry-models/how-to/use-foundry-models-mai-thinking)** `[📘 Official]`
  Official MAI-Thinking-1 API contract, operational limits, and reasoning-state behavior.

- 📘 **[Observability in generative AI](https://learn.microsoft.com/azure/foundry/concepts/observability)** `[📘 Official]`
  Foundry guidance for lifecycle evaluation, monitoring, and tracing.
...
- 📘 **[Compare models using the model leaderboard (preview)](https://learn.microsoft.com/azure/foundry/how-to/benchmark-model-in-catalog)** `[📘 Official]`
  Foundry workflow for comparing models across quality, safety, cost, and throughput.
...
- **[01. How GitHub Copilot Uses Markdown and Prompt Folders](../01-overview/01.00-the-github-copilot-customization-stack.md)** - BYOK model configuration
- **[03. How to Structure Content for Copilot Prompt Files](./03.00-how-to-structure-content-for-copilot-prompt-files.md)** - YAML `model` field usage
...
|----------|----------|----------------|---------------|
| [08.01 OpenAI Prompting Guide Analysis](./08.01-appendix-openai-prompting-guide.md) | OpenAI | GPT-4o, GPT-5, o3, o4-mini | 2026-02-20 |
| [08.02 Anthropic Prompting Guide Analysis](./08.02-appendix-anthropic-prompting-guide.md) | Anthropic | Claude Sonnet 4, Opus 4.6, Extended Thinking | 2026-02-20 |
| [08.03 Google Prompting Guide Analysis](./08.03-appendix-google-prompting-guide.md) | Google | Gemini 2.0, Gemini 3 | 2026-02-20 |
...
```yaml
article_metadata:
  filename: "08.00-how-to-optimize-prompts-for-specific-models.md"
  type: "how-to"
  word_count: ~3500
...
cross_references:
  series:
    ...
    part: 8
    previous: "./07.00-how-to-create-mcp-servers-for-copilot.md"
    next: null
  related_articles:
    - path: "../01-overview/01.00-the-github-copilot-customization-stack.md"
      relationship: "references"
    - path: "./03.00-how-to-structure-content-for-copilot-prompt-files.md"
      relationship: "references"
    - path: "../../01.00-news/20260111-6-vital-rules-for-production-ready-copilot-agents/summary.md"
      relationship: "source"
  appendices:
    - path: "./08.01-appendix-openai-prompting-guide.md"
      title: "OpenAI Prompting Guide Analysis"
    - path: "./08.02-appendix-anthropic-prompting-guide.md"
      title: "Anthropic Prompting Guide Analysis"
    - path: "./08.03-appendix-google-prompting-guide.md"
