...
> **📘 Note**: For detailed guidance on Agent Skills (Preview), see [How to Structure Content for GitHub Copilot Skills](./06.00-how_to_structure_content_for_copilot_skills.md).
...
**[How GitHub Copilot Uses Markdown and Prompt Folders](../01-overview/01.00-the_github_copilot_customization_stack.md)** `[📙 Internal]`  
...
**[How to Name and Organize Prompt Files](../02-getting-started/02.00-how_to_name_and_organize_prompt_files.md)** `[📙 Internal]`  
