...
- [Message Roles and Authority Chain 🏗️](#message-roles-and-authority-chain)
- [Prompt Structure Best Practices 📝](#prompt-structure-best-practices)
- [Few-Shot Learning Techniques 🎯](#few-shot-learning-techniques)
- [Formatting with Markdown and XML 📐](#formatting-with-markdown-and-xml)
- [Reasoning Models (o3, o4-mini) 🧠](#reasoning-models-o3-o4-mini)
- [GPT-5 Specific Optimizations ⚡](#gpt-5-specific-optimizations)
- [Cost Optimization: Prompt Caching 💰](#cost-optimization-prompt-caching)
...
- 📘 **[OpenAI Model Spec](https://model-spec.openai.com/2025-02-12.html)** `[📘 Official]`
  Defines model behavior, chain of command, and message priorities.

- 📘 **[OpenAI Prompt Caching](https://platform.openai.com/docs/guides/prompt-caching)** `[📘 Official]`
  Cost optimization through content caching.

### Related Resources

- 📘 **[OpenAI Cookbook](https://cookbook.openai.com/)** `[📘 Official]`
  Example code and real-world use cases.

- 📘 **[GPT-5 Prompting Guide](https://cookbook.openai.com/examples/gpt-5/gpt-5_prompting_guide)** `[📘 Official]`
...
```yaml
article_metadata:
  filename: "08.01-appendix-openai-prompting-guide.md"
  type: "appendix"
