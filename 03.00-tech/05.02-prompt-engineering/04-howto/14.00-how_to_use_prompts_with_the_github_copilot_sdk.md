...
- [🎚️ Multi-model routing](#️-multi-model-routing)
...
The SDK doesn't introduce a new prompt format. It reuses <mark>`.prompt.md`</mark>, <mark>`.agent.md`</mark>, <mark>`.instructions.md`</mark>, and <mark>`SKILL.md`</mark> files exactly as documented in [articles 01–06](../01-overview/01.00-the_github_copilot_customization_stack.md) of this series.
...
When the SDK client starts, the CLI server scans the workspace for prompt files. The scanning follows the same rules documented in [article 01](../01-overview/01.00-the_github_copilot_customization_stack.md):
...
- **Multi-model routing** — Apply the model-per-task patterns from [article 08](./08.00-how_to_optimize_prompts_for_specific_models.md) with full flexibility
...
**[How GitHub Copilot Uses Markdown and Prompt Folders](../01-overview/01.00-the_github_copilot_customization_stack.md)** 📗 [Verified Community]  
...
- **[01. How Copilot Uses Markdown and Prompt Folders](../01-overview/01.00-the_github_copilot_customization_stack.md)** — Overview of all Copilot customization surfaces
- **[04. Agent Files](./04.00-how_to_structure_content_for_copilot_agent_files.md)** — Agent design patterns used in SDK apps
- **[06. Skills](./06.00-how_to_structure_content_for_copilot_skills.md)** — Portable skills consumed by SDK apps
- **[07. MCP Servers](./07.00-how_to_create_mcp_servers_for_copilot.md)** — Building MCP servers for SDK integration
- **[08. Model-Specific Prompting](./08.00-how_to_optimize_prompts_for_specific_models.md)** — Multi-model routing strategies
...
cross_references:
  series:
    ...
    next: null
  related_articles:
    - path: "../01-overview/01.00-the_github_copilot_customization_stack.md"
