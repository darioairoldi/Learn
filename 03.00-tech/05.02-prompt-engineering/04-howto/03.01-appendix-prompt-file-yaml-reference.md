...
This file contains the YAML frontmatter reference appendix extracted from the [How to structure content for GitHub Copilot prompt files](03.00-how-to-structure-content-for-copilot-prompt-files.md) article. It provides comprehensive documentation of all metadata fields supported in `.prompt.md` YAML frontmatter across GitHub Copilot implementations and related tools.
