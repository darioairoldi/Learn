...
description: "Deep analysis of Anthropic's official prompting guides for Claude Sonnet 4, Opus 4.6, and Extended Thinking models with extracted techniques and examples"
guide_version:
...
This appendix provides a <mark>comprehensive analysis</mark> of Anthropic's official prompting documentation, extracting key techniques, patterns, and recommendations for **Claude Sonnet 4**, **Claude Opus 4.6**, and **Extended Thinking** models.
...
- [The Golden Rule of Clarity 🎯](#the-golden-rule-of-clarity)
- [Recommended Technique Order 📐](#recommended-technique-order)
- [XML Tags for Structure 🏷️](#xml-tags-for-structure)
- [Chain of Thought Prompting 💭](#chain-of-thought-prompting)
- [Opus 4.6 Optimization Strategies 🚀](#opus-46-optimization-strategies)
- [Extended Thinking Mode 🧠](#extended-thinking-mode)
- [Multishot Prompting 📚](#multishot-prompting)
- [System Prompts and Roles 👤](#system-prompts-and-roles)
- [Long Context Tips 📝](#long-context-tips)
- [Prefilling Claude's Response ✂️](#prefilling-claudes-response)
...
1. ✅ **Clear success criteria** defined for your use case
2. ✅ **Empirical testing** methods established
3. ✅ **First draft prompt** ready to improve
...
Claude Opus 4.6 is Anthropic's <mark>**frontier model**</mark>, designed for the most demanding agentic and analytical tasks. It builds on Opus 4's strengths with significant improvements in multi-step tool use, instruction fidelity, and long-context recall.

### When to choose Opus 4.6

| Scenario | Why Opus 4.6 |
|----------|-------------|
| **Multi-step agentic workflows** | <mark>Excels</mark> at <mark>sequencing tool calls correctly across many steps</mark> |
| **Dense system prompts** | <mark>Supports</mark> <mark>highly detailed instructions</mark> with minimal drift |
| **Extended context fidelity** | <mark>Better recall</mark> across long contexts compared to Sonnet 4 |
| **Complex analysis + writing** | <mark>Produces more nuanced, thorough outputs</mark> than Opus 4 |

### Prompting tips for Opus 4.6

- **<mark>Don't simplify instructions</mark>** — Opus 4.6 handles dense, layered prompts well. Where Sonnet benefits from concise guidance, Opus 4.6 thrives with comprehensive detail.
- **<mark>Trust tool sequencing</mark>** — In agentic workflows, Opus 4.6 reliably chains tool calls in the correct order. Provide the goal and constraints rather than scripting each step.
- **<mark>Leverage long context</mark>** — Place reference material early in the context window. Opus 4.6 maintains better recall across the full 200K token window than prior Opus models.
- **<mark>Pair with Extended Thinking</mark>** — For maximum reasoning depth on complex analysis tasks, enable Extended Thinking mode with Opus 4.6. The combination delivers the strongest results for STEM, planning, and constraint satisfaction problems.

> **⚠️ Note:** Verify these details against the [official Anthropic Opus 4.6 release documentation](https://docs.anthropic.com/en/docs/about-claude/models) before publishing. Model capabilities may evolve.
...
- 📘 **[Be Clear and Direct](https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/be-clear-and-direct)** `[📘 Official]`
  Foundation of effective Claude prompting.

- 📘 **[Chain of Thought Prompting](https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/chain-of-thought)** `[📘 Official]`
  Detailed CoT techniques and examples.

- 📘 **[Extended Thinking Tips](https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/extended-thinking-tips)** `[📘 Official]`
  Advanced techniques for extended thinking mode.

- 📘 **[Use XML Tags](https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/use-xml-tags)** `[📘 Official]`
  Structuring prompts with XML.

- 📘 **[Multishot Prompting](https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/multishot-prompting)** `[📘 Official]`
  Few-shot example techniques.

### Interactive Resources

- 📘 **[GitHub Prompting Tutorial](https://github.com/anthropics/prompt-eng-interactive-tutorial)** `[📘 Official]`
  Interactive examples covering all techniques.

- 📘 **[Google Sheets Prompting Tutorial](https://docs.google.com/spreadsheets/d/19jzLgRruG9kjUQNKtCg1ZjdD6l6weA6qRXG5zLIAhC8)** `[📘 Official]`
  Lightweight interactive version.

- 📘 **[Claude Prompt Library](https://platform.claude.com/docs/en/resources/prompt-library/library)** `[📘 Official]`
  Curated prompts for various use cases.

---

**Parent Article:** [08.00 How to Optimize Prompts for Specific Models](./08.00-how-to-optimize-prompts-for-specific-models.md)
...
```yaml
article_metadata:
  filename: "08.02-appendix-anthropic-prompting-guide.md"
  type: "appendix"
  parent: "08.00-how-to-optimize-prompts-for-specific-models.md"
  word_count: ~2600
