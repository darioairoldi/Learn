...
- [Input Types and Formatting 📥](#input-types-and-formatting)
- [Zero-Shot vs Few-Shot Prompting 🎯](#zero-shot-vs-few-shot-prompting)
- [Structured Prompting with Tags 📐](#structured-prompting-with-tags)
- [Completion Strategy (Prefilling) ✂️](#completion-strategy-prefilling)
- [Context and Grounding 📚](#context-and-grounding)
- [Breaking Down Complex Prompts 🔀](#breaking-down-complex-prompts)
- [Model Parameters ⚙️](#model-parameters)
- [Gemini 3 Specific Techniques 🧠](#gemini-3-specific-techniques)
- [Agentic Workflow Optimization 🤖](#agentic-workflow-optimization)
...
- 📘 **[Gemini 3 Model Documentation](https://ai.google.dev/gemini-api/docs/gemini-3)** `[📘 Official]`
  Specific guidance for Gemini 3 family.

- 📘 **[Prompting with Media Files](https://ai.google.dev/gemini-api/docs/files#prompt-guide)** `[📘 Official]`
  Multimodal prompting techniques.

- 📘 **[Gemini API Reference](https://ai.google.dev/api)** `[📘 Official]`
  Complete API documentation.

### Interactive Resources

- 📘 **[Google AI Studio](https://aistudio.google.com/)** `[📘 Official]`
  Interactive prompt development environment.

- 📘 **[Prompt Gallery](https://ai.google.dev/gemini-api/prompts)** `[📘 Official]`
  Sample prompts showcasing key concepts.

### Related Guides

- 📘 **[Long Context Guide](https://ai.google.dev/gemini-api/docs/long-context)** `[📘 Official]`
  Working with large context windows.

- 📘 **[Function Calling](https://ai.google.dev/gemini-api/docs/function-calling)** `[📘 Official]`
  Tool use and function invocation.

- 📘 **[Structured Output](https://ai.google.dev/gemini-api/docs/structured-output)** `[📘 Official]`
...
```yaml
article_metadata:
  filename: "08.03-appendix-google-prompting-guide.md"
  type: "appendix"
