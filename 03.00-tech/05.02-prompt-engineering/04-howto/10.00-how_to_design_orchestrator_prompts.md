...
- [ðŸŽ¯ The problem: monolithic prompts don't scale](#-the-problem-monolithic-prompts-dont-scale)
- [ðŸ—ï¸ The orchestrator pattern](#ï¸-the-orchestrator-pattern)
- [ðŸ“‹ Designing specialized agents](#-designing-specialized-agents)
- [ðŸ”€ Phase-based coordination](#-phase-based-coordination)
- [ðŸŽ¯ The use case challenge methodology](#-the-use-case-challenge-methodology)
- [ðŸ§  Architecture decisions: when to orchestrate](#-architecture-decisions-when-to-orchestrate)
- [âš™ï¸ Execution flow control](#ï¸-execution-flow-control)
- [ðŸŽ›ï¸ Context engineering for orchestrators](#ï¸-context-engineering-for-orchestrators)
- [ðŸ’¡ Key design principles](#-key-design-principles)
- [ðŸŽ¯ Conclusion](#-conclusion-1)
- [ðŸ“š References](#-references)

---

## ðŸŽ¯ The problem: monolithic prompts don't scale
...
## ðŸ“‹ Designing specialized agents
...
## ðŸŽ¯ The use case challenge methodology
...
## ðŸ§  Architecture decisions: when to orchestrate
...
Every orchestrator operates within a <mark>context window budget</mark>. <mark>The orchestrator's own context should stay lean</mark>â€”it's primarily a decision-making layer, not a processing layer.
...
- **[Orchestrator Design Case Study](../05-analysis/20-how_to_create_a_prompt_interacting_with_agents.md)** â€” A full implementation walkthrough applying these patterns to a real agent-writing workflow
...
**[VS Code: Chat Sessions](https://code.visualstudio.com/docs/copilot/chat/chat-sessions)** `[ðŸ“˜ Official]`  
...
**[How to Design Subagent Orchestrations](./11.00-how_to_design_subagent_orchestrations.md)** `[ðŸ“™ Internal]`  
