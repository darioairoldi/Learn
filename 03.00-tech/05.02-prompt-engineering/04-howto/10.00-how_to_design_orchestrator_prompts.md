...
- [🏗️ The orchestrator pattern](#️-the-orchestrator-pattern)
...
- [⚙️ Execution flow control](#️-execution-flow-control)
- [🎛️ Context engineering for orchestrators](#️-context-engineering-for-orchestrators)
