...
- [✍️ Compose Clear and Structured Content](#%EF%B8%8F-compose-clear-and-structured-content)
...
- [🖥️ Environment-Specific Considerations](#%EF%B8%8F-environment-specific-considerations)
...
| **MCP Servers** | ⚠️ Preview (1.106+) | ❌ Not supported |
...
| > 4,000 tokens | 25+ seconds | < 60% | ⚠️ Refactor required |
...
model: Claude Sonnet 4.6  # Unquoted string with spaces
---
```
