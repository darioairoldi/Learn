...
- [Understanding Instruction Files 🎯](#understanding-instruction-files)
- [Instruction File Structure 📋](#instruction-file-structure)
- [Writing Effective Instructions ✍️](#writing-effective-instructions)
...
**⚠️ Important**: <mark>If `applyTo` is omitted, instructions are **not applied automatically**</mark> - you must attach them manually to chat requests.
...
Active Instructions:
├── copilot-instructions.md (300 tokens)
├── react-guidelines.instructions.md (250 tokens)  
├── typescript-standards.instructions.md (200 tokens)
├── testing-requirements.instructions.md (150 tokens)
└── accessibility-rules.instructions.md (100 tokens)
...
**⚠️ If instructions exceed 1,000 tokens**, you'll see:
...
|-------|-------------------|------------|
| < 50 | ~300 tokens | ✅ Excellent - Focused and concise |
| 50-100 | ~300-600 tokens | ✅ Good - Standard size |
| 100-150 | ~600-900 tokens | ⚠️ Getting long - Review for redundancy |
| 150-200 | ~900-1,200 tokens | 🔴 Too long - Split recommended |
| > 200 | > 1,200 tokens | 🚫 Excessive - Must refactor |
...
**Benefits:**
- ✅ Only relevant instructions apply to each file
- ✅ Easier to maintain individual files
- ✅ Reduced context consumption per file
...
|---------------------------|-------------------|--------|----------------|
| 1-2 files | < 600 tokens | ✅ Minimal | Ideal |
| 3-4 files | 600-1,200 tokens | ✅ Low | Acceptable |
| 5-7 files | 1,200-2,000 tokens | ⚠️ Moderate | Review for overlap |
| 8+ files | > 2,000 tokens | 🔴 High | Consolidate or narrow patterns |
...
> **📘 Note**: For detailed guidance on Agent Skills (Preview), see [How to Structure Content for GitHub Copilot Skills](./06.00-how-to-structure-content-for-copilot-skills.md).
...
**[GitHub: Adding Repository Custom Instructions](https://docs.github.com/en/copilot/customizing-copilot/adding-custom-instructions-for-github-copilot)** `[📘 Official]`  
...
**[VS Code: Use Custom Instructions](https://code.visualstudio.com/docs/copilot/customization/custom-instructions)** `[📘 Official]`  
...
**[GitHub Blog: How to Use GitHub Copilot - Tips, Tricks, and Best Practices](https://github.blog/developer-skills/github/how-to-use-github-copilot-in-your-ide-tips-tricks-and-best-practices/)** `[📗 Verified Community]`  
...
**[Awesome GitHub Copilot Repository](https://github.com/github/awesome-copilot)** `[📗 Verified Community]`  
...
**[GitHub Blog: Prompting with GitHub Copilot](https://github.blog/2023-06-20-how-to-write-better-prompts-for-github-copilot/)** `[📗 Verified Community]`  
...
**[How GitHub Copilot Uses Markdown and Prompt Folders](../01-overview/01.00-the-github-copilot-customization-stack.md)** `[📙 Internal]`  
...
**[How to Name and Organize Prompt Files](../02-getting-started/02.00-how-to-name-and-organize-prompt-files.md)** `[📙 Internal]`  
...
**[How to Structure Content for Copilot Prompt Files](./03.00-how-to-structure-content-for-copilot-prompt-files.md)** `[📙 Internal]`  
...
article_metadata:
  filename: "05.00-how-to-structure-content-for-copilot-instruction-files.md"
  created: "2025-12-11"
  last_updated: "2025-12-24"
  version: "1.1"
  status: "draft"
  changelog: "05.00-how_to_structure_content_for_copilot_instruction_files.changelog.md"
  word_count: 6200
