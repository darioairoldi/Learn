...
Up to this point in the series, you've learned how to structure individual customization files: [instructions](./05.00-how_to_structure_content_for_copilot_instruction_files.md), [prompts](./03.00-how_to_structure_content_for_copilot_prompt_files.md), [agents](./04.00-how_to_structure_content_for_copilot_agent_files.md), [skills](./06.00-how_to_structure_content_for_copilot_skills.md), and [hooks](./09.00-how_to_use_agent_hooks_for_lifecycle_automation.md). Each one handles a specific piece of the customization puzzle. But real-world workflows often require **multiple agents working together**—a planner gathering context, a builder implementing changes, a reviewer checking quality.
...
Every orchestator operates within a <mark>context window budget</mark>. <mark>The orchestrator's own context should stay lean</mark>—it's primarily a decision-making layer, not a processing layer.
...
- **[Orchestrator Design Case Study](./20-how_to_create_a_prompt_interacting_with_agents.md)** — A full implementation walkthrough applying these patterns to a real agent-writing workflow
...
**[Orchestrator Design Case Study](./20-how_to_create_a_prompt_interacting_with_agents.md)** `[📙 Internal]`  
