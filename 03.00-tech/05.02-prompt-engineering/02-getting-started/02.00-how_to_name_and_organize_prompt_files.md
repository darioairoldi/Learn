...
**For detailed guidance on creating and structuring custom agent files, including persona design, tool configuration, and handoff workflows, see [How to Structure Content for Copilot Agent Files](../04-howto/04.00-how_to_structure_content_for_copilot_agent_files.md).**
...
article_metadata:
  filename: "02.00-how_to_name_and_organize_prompt_files.md"
  created: "2025-12-26"
