...
<mark>Consistent naming and logical folder organization are the foundation of an effective prompt library</mark>. When every team member can discover and understand prompts through predictable naming conventions, your entire prompt engineering investment pays dividends. Start with the official `.github/prompts/` location, adopt descriptive `kebab-case` names, and organize prompts by workflow category. As your library grows, use subdirectories and clear README files to keep everything navigable. The time you invest in organization today prevents confusion and duplication tomorrow.
...
**For detailed guidance on creating and structuring custom agent files, including persona design, tool configuration, and handoff workflows, see [How to Structure Content for Copilot Agent Files](../04-howto/04.00-how-to-structure-content-for-copilot-agent-files.md).**
...
article_metadata:
  filename: "02.00-how-to-name-and-organize-prompt-files.md"
  created: "2025-12-26"
  ...
  primary_topic: "Prompt File Organization"
