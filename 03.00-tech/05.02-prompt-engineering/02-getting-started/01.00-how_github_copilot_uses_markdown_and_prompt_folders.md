...
## Prompt Assembly Architecture 🏗️
...
This growth is why <mark>**starting new chat sessions frequently**</mark> matters. As the context window fills, the model's accuracy on earlier instructions degrades—a phenomenon called <mark>context rot</mark>. For a deeper treatment of this effect and strategies to manage it, see [How to Manage Information Flow During Prompt Orchestrations](../04-howto/12.00-how_to_manage_information_flow_during_prompt_orchestrations.md) and [How to Optimize Token Consumption](../04-howto/13.00-how_to_optimize_token_consumption_during_prompt_orchestrations.md).
