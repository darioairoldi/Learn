...
- [How to Create a Prompt Orchestrating Multiple Agents](./20-how_to_create_a_prompt_interacting_with_agents.md) — Detailed orchestrator design, including execution contexts (Local, Background, Cloud) that affect information isolation
...
**[How to Create a Prompt Orchestrating Multiple Agents](./20-how_to_create_a_prompt_interacting_with_agents.md)** 📒 [Internal]  
