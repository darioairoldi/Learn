...
> 📖 **How-to:** [How to structure content for Copilot prompt files](../04-howto/03.00-how-to-structure-content-for-copilot-prompt-files.md)
...
> 📖 **How-to:** [How to structure content for Copilot agent files](../04-howto/04.00-how-to-structure-content-for-copilot-agent-files.md)
...
- [How to structure content for Copilot prompt files](../04-howto/03.00-how-to-structure-content-for-copilot-prompt-files.md) — Appendix A contains expanded field documentation
- [How to structure content for Copilot agent files](../04-howto/04.00-how-to-structure-content-for-copilot-agent-files.md) — Core and advanced field tables
- [How to structure content for Copilot instruction files](../04-howto/05.00-how-to-structure-content-for-copilot-instruction-files.md) — applyTo patterns and scope
- [How to structure content for Copilot skills](../04-howto/06.00-how-to-structure-content-for-copilot-skills.md) — Name constraints and description best practices
- [How to use agent hooks for lifecycle automation](../04-howto/09.00-how-to-use-agent-hooks-for-lifecycle-automation.md) — Hook JSON schema and events
- [How to leverage tools in prompt orchestrations](../04-howto/09.50-how-to-leverage-tools-in-prompt-orchestrations.md) — Runtime tools catalog
...
article_metadata:
  filename: "01.11-yaml-frontmatter-reference.md"
  created: "2026-03-07"
...
cross_references:
  related_articles:
    ...
    - "09.50-how-to-leverage-tools-in-prompt-orchestrations.md"
