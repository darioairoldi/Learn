...
This article is a lookup reference for GitHub Copilot's configuration surface. It consolidates settings tables, deprecated settings with migration paths, BYOK provider details, legacy file migration steps, and JetBrains IDE compatibility into one place. For conceptual explanations of *why* these settings exist and how they fit the customization stack, see the concept articles in this series — in particular [Understanding prompt files, instructions, and context layers](../03-concepts/01.03-understanding-prompt-files-instructions-and-context-layers.md) and [Understanding LLM models and model selection](../03-concepts/01.07-understanding-llm-models-and-model-selection.md).

## Table of contents

- [VS Code settings reference ⚙️](#vs-code-settings-reference)
- [Deprecated VS Code settings ⚠️](#deprecated-vs-code-settings)
...
- [JetBrains IDE support 🖥️](#jetbrains-ide-support)
...
<mark>**Recommendation:**</mark> Migrate to the new format for consistency with current documentation and to ensure future compatibility. For details on creating agents with the current format, see [How to structure content for Copilot agent files](../04-howto/04.00-how-to-structure-content-for-copilot-agent-files.md).
...
- [Understanding prompt files, instructions, and context layers](../03-concepts/01.03-understanding-prompt-files-instructions-and-context-layers.md) — conceptual foundation for the settings in this reference
- [Understanding LLM models and model selection](../03-concepts/01.07-understanding-llm-models-and-model-selection.md) — model selection strategies beyond the BYOK tables
- [How to structure content for Copilot instruction files](../04-howto/05.00-how-to-structure-content-for-copilot-instruction-files.md) — practical guidance for the instruction files that replace deprecated settings
- [How to optimize prompts for specific models](../04-howto/08.00-how-to-optimize-prompts-for-specific-models.md) — tailoring prompts for specific BYOK models
...
article_metadata:
  filename: "01.09-copilot-settings-ide-support-and-compatibility-reference.md"
  created: "2026-03-01"
...
cross_references:
  related_articles:
    ...
    - "08.00-how-to-optimize-prompts-for-specific-models.md"
