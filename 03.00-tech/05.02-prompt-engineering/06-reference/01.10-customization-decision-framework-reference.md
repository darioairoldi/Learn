...
- [Written customizations: prompts vs. instructions vs. context files ✏️](#written-customizations-prompts-vs-instructions-vs-context-files)
- [Identity and capabilities: agents vs. skills 🤖](#identity-and-capabilities-agents-vs-skills)
- [Enforcement: hooks vs. instructions ⚖️](#enforcement-hooks-vs-instructions)
...
> 📖 **Deep dive:** [Understanding prompt files, instructions, and context layers](../03-concepts/01.03-understanding-prompt-files-instructions-and-context-layers.md)
...
> 📖 **Deep dive:** [Understanding agents](../03-concepts/01.04-understanding-agents-invocation-handoffs-and-subagents.md) | [Understanding skills and hooks](../03-concepts/01.05-understanding-skills-hooks-and-lifecycle-automation.md)
...
> 📖 **Deep dive:** [Understanding skills, hooks, and lifecycle automation](../03-concepts/01.05-understanding-skills-hooks-and-lifecycle-automation.md)
...
> 📖 **Deep dive:** [Understanding MCP and the tool ecosystem](../03-concepts/01.06-understanding-mcp-and-the-tool-ecosystem.md) | 📖 **How-to:** [How to create MCP servers](../04-howto/07.00-how-to-create-mcp-servers-for-copilot.md)
...
> 📖 **Deep dive:** [Understanding Copilot Memory](../03-concepts/01.09-understanding-copilot-memory-and-persistent-context.md)
...
> 📖 **How-to:** [How to leverage tools in prompt orchestrations](../04-howto/09.50-how-to-leverage-tools-in-prompt-orchestrations.md)
...
> 📖 **Deep dive:** [Understanding LLM models and model selection](../03-concepts/01.07-understanding-llm-models-and-model-selection.md) | 📖 **How-to:** [How to optimize prompts for specific models](../04-howto/08.00-how-to-optimize-prompts-for-specific-models.md)
...
> 📖 **How-to:** [How to create MCP servers for Copilot](../04-howto/07.00-how-to-create-mcp-servers-for-copilot.md)
...
- [Understanding prompt files, instructions, and context layers](../03-concepts/01.03-understanding-prompt-files-instructions-and-context-layers.md) — Written customization types
- [Understanding agents, invocation, handoffs, and subagents](../03-concepts/01.04-understanding-agents-invocation-handoffs-and-subagents.md) — Agent identity and orchestration
- [Understanding skills, hooks, and lifecycle automation](../03-concepts/01.05-understanding-skills-hooks-and-lifecycle-automation.md) — Portable capabilities and enforcement
- [Understanding MCP and the tool ecosystem](../03-concepts/01.06-understanding-mcp-and-the-tool-ecosystem.md) — External tool integration
- [Understanding LLM models and model selection](../03-concepts/01.07-understanding-llm-models-and-model-selection.md) — Model families and selection
- [Understanding Copilot Memory and persistent context](../03-concepts/01.09-understanding-copilot-memory-and-persistent-context.md) — Cross-session persistence

**Series how-to articles:**
- [How to structure content for Copilot prompt files](../04-howto/03.00-how-to-structure-content-for-copilot-prompt-files.md)
- [How to structure content for Copilot agent files](../04-howto/04.00-how-to-structure-content-for-copilot-agent-files.md)
- [How to structure content for Copilot instruction files](../04-howto/05.00-how-to-structure-content-for-copilot-instruction-files.md)
- [How to structure content for Copilot skills](../04-howto/06.00-how-to-structure-content-for-copilot-skills.md)
- [How to create MCP servers for Copilot](../04-howto/07.00-how-to-create-mcp-servers-for-copilot.md)
- [How to use agent hooks for lifecycle automation](../04-howto/09.00-how-to-use-agent-hooks-for-lifecycle-automation.md)
- [How to leverage tools in prompt orchestrations](../04-howto/09.50-how-to-leverage-tools-in-prompt-orchestrations.md)
...
article_metadata:
  filename: "01.10-customization-decision-framework-reference.md"
  created: "2026-03-07"
...
cross_references:
  related_articles:
    ...
    - "01.09-understanding-copilot-memory-and-persistent-context.md"
