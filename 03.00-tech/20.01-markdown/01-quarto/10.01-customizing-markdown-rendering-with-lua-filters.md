...
- [Understanding Quarto's Rendering Process ⚙️](#understanding-quartos-rendering-process)
  - [The Rendering Pipeline](#the-rendering-pipeline)
  - [Pandoc Markdown Extensions](#pandoc-markdown-extensions)
- [Lua Filters: Intercepting the Conversion 🔧](#lua-filters-intercepting-the-conversion)
...
- [Creating Your First Lua Filter 🚀](#creating-your-first-lua-filter)
  - [Basic Filter Structure](#basic-filter-structure)
  - [Element Types](#element-types)
- [Advanced Filter Techniques 🎯](#advanced-filter-techniques)
...
- [Quarto Filter Extensions 📦](#quarto-filter-extensions)
...
- [Resources 📚](#resources)
- [Appendix A: The Bullet List Problem 📎](#appendix-a-the-bullet-list-problem)
- [Appendix B: Alternatives to Lua Filters 🔀](#appendix-b-alternatives-to-lua-filters)
...
**[Pandoc Lua Filters Documentation](https://pandoc.org/lua-filters.html)** [📘 Official]  
...
**[Quarto Extensions Guide](https://quarto.org/docs/extensions/)** [📘 Official]  
...
**[Pandoc AST Reference](https://pandoc.org/lua-filters.html#type-ref)** [📘 Official]  
...
**[Lua 5.3 Reference Manual](https://www.lua.org/manual/5.3/)** [📘 Official]  
...
**[Pandoc Lua Filters Repository](https://github.com/pandoc/lua-filters)** [📗 Verified Community]  
...
**[Quarto Filter Development Best Practices](https://quarto.org/docs/extensions/filters.html)** [📘 Official]  
...
**[Pandoc User's Guide - Filters Section](https://pandoc.org/MANUAL.html#filters)** [📘 Official]  
...
**[Lua Filter Tutorial by Albert Krewinkel](https://github.com/pandoc/lua-filters/blob/master/CONTRIBUTING.md)** [📗 Verified Community]  
...
**[Quarto CLI Reference](https://quarto.org/docs/reference/)** [📘 Official]  
...
**[Pandoc Discussions - Lua Filters](https://github.com/jgm/pandoc/discussions/categories/lua-filters)** [📗 Verified Community]  
...
**[Lua 5.4 Updates](https://www.lua.org/manual/5.4/manual.html)** [📘 Official]  
...
**[Quarto Journal Articles Extension](https://github.com/quarto-journals/)** [📗 Verified Community]  
...
article_metadata:
  ...
  changelog: "10.01-customizing-markdown-rendering-with-lua-filters.changelog.md"
  validation:
