...
- **[Goldmark GitHub](https://github.com/yuin/goldmark)** 📘 Official - Parser source code
- **[Hugo Markdown Configuration](https://gohugo.io/getting-started/configuration-markup/)** 📘 Official - Complete config reference
- **[CommonMark Spec](https://spec.commonmark.org/)** 📘 Official - Markdown specification
- **[Chroma Styles Gallery](https://xyproto.github.io/splash/docs/)** 📗 Verified Community - Visual style preview
- **[Hugo Render Hooks](https://gohugo.io/templates/render-hooks/)** 📘 Official - Custom rendering guide
- **[Syntax Highlighting](https://gohugo.io/content-management/syntax-highlighting/)** 📘 Official - Chroma configuration
