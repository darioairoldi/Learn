...
2. [Available Approaches](#available-approaches)
   - [Azure.Data.Tables SDK (Recommended)](#azuredatatables-sdk-recommended)
   - [Azure Cosmos DB Table API](#azure-cosmos-db-table-api)
...
7. [Authentication Approaches](#authentication-approaches)
   - [Managed Identity (Recommended)](#managed-identity-recommended-for-azure-hosted-apps)
   - [Connection String (Development/Local)](#connection-string-developmentlocal)
   - [Service Principal (CI/CD)](#service-principal-cicd)
