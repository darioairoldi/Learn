...
2. [Available Approaches 🚀](#available-approaches)
   - [Azure.Storage.Blobs SDK (Recommended)](#azurestorageblobs-sdk-recommended)
   - [REST API Direct Access](#rest-api-direct-access)
   - [Legacy Approaches (Deprecated)](#legacy-approaches-deprecated)
3. [Key Libraries 📦](#key-libraries)
   - [Primary Library](#primary-library)
   - [Supporting Libraries (Optional)](#supporting-libraries-optional)
4. [Basic Operations ⚙️](#basic-operations)
...
7. [Authentication Approaches 🔐](#authentication-approaches)
   ...
   - [Account Key (Not Recommended)](#account-key-not-recommended)
