...
> Fabric also offers other stores — a **SQL database** workload (OLTP) and **Eventhouse/KQL** for real-time intelligence — but those serve different jobs and are outside this series' scope.
...
- **[Mapping Fabric to legacy Microsoft data products](04.01-mapping-fabric-to-legacy-data-products.md)** — Synapse, ADLS, Analysis Services, and Azure SQL.
