---
title: "pe-meta-review validation runbook"
...
# pe-meta-review validation runbook
...
- Path: `C:\dev\darioairoldi\Learn\.github\prompts\00.09-pe-meta\pe-meta-review.prompt.md`
- Status file: `../02.26-validation-status-pe-meta-review.md`
...
5. Update checkboxes in `../02.26-validation-status-pe-meta-review.md`.
