---
title: "pe-meta-researcher validation runbook"
...
# pe-meta-researcher validation runbook
...
- Path: `C:\dev\darioairoldi\Learn\.github\agents\00.09-pe-meta\pe-meta-researcher.agent.md`
- Status file: `../02.05-validation-status-pe-meta-researcher.md`
...
5. Update checkboxes in `../02.05-validation-status-pe-meta-researcher.md`.
