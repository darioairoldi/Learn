---
title: "pe-meta-skill-create-update validation runbook"
...
# pe-meta-skill-create-update validation runbook
...
- Path: `C:\dev\darioairoldi\Learn\.github\prompts\00.09-pe-meta\pe-meta-skill-create-update.prompt.md`
- Status file: `../02.28-validation-status-pe-meta-skill-create-update.md`
...
5. Update checkboxes in `../02.28-validation-status-pe-meta-skill-create-update.md`.
