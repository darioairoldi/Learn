---
title: "pe-meta-validator validation runbook"
...
# pe-meta-validator validation runbook
...
- Path: `C:\dev\darioairoldi\Learn\.github\agents\00.09-pe-meta\pe-meta-validator.agent.md`
- Status file: `../02.06-validation-status-pe-meta-validator.md`
...
5. Update checkboxes in `../02.06-validation-status-pe-meta-validator.md`.
