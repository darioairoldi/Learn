---
title: "pe-meta-template-create-update validation runbook"
...
# pe-meta-template-create-update validation runbook
...
- Path: `C:\dev\darioairoldi\Learn\.github\prompts\00.09-pe-meta\pe-meta-template-create-update.prompt.md`
- Status file: `../02.34-validation-status-pe-meta-template-create-update.md`
...
5. Update checkboxes in `../02.34-validation-status-pe-meta-template-create-update.md`.
