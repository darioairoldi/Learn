---
title: "pe-meta-prompt-review validation runbook"
...
# pe-meta-prompt-review validation runbook
...
- Path: `C:\dev\darioairoldi\Learn\.github\prompts\00.09-pe-meta\pe-meta-prompt-review.prompt.md`
- Status file: `../02.24-validation-status-pe-meta-prompt-review.md`
...
5. Update checkboxes in `../02.24-validation-status-pe-meta-prompt-review.md`.
