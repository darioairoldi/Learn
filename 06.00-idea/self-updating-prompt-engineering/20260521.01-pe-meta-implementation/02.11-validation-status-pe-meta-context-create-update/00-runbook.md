---
title: "pe-meta-context-create-update validation runbook"
...
# pe-meta-context-create-update validation runbook
...
- Path: `C:\dev\darioairoldi\Learn\.github\prompts\00.09-pe-meta\pe-meta-context-create-update.prompt.md`
- Status file: `../02.11-validation-status-pe-meta-context-create-update.md`
...
5. Update checkboxes in `../02.11-validation-status-pe-meta-context-create-update.md`.
