---
title: "pe-meta-release-monitor validation runbook"
...
# pe-meta-release-monitor validation runbook
...
- Path: `C:\dev\darioairoldi\Learn\.github\prompts\00.09-pe-meta\pe-meta-release-monitor.prompt.md`
- Status file: `../02.25-validation-status-pe-meta-release-monitor.md`
...
5. Update checkboxes in `../02.25-validation-status-pe-meta-release-monitor.md`.
