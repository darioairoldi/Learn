---
title: "pe-meta-adherence validation runbook"
...
# pe-meta-adherence validation runbook
...
- Path: `C:\dev\darioairoldi\Learn\.github\prompts\00.09-pe-meta\pe-meta-adherence.prompt.md`
- Status file: `../02.07-validation-status-pe-meta-adherence.md`
...
5. Update checkboxes in `../02.07-validation-status-pe-meta-adherence.md`.
