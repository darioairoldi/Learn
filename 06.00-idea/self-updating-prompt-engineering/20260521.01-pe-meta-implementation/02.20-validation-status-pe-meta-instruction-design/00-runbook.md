---
title: "pe-meta-instruction-design validation runbook"
...
# pe-meta-instruction-design validation runbook
...
- Path: `C:\dev\darioairoldi\Learn\.github\prompts\00.09-pe-meta\pe-meta-instruction-design.prompt.md`
- Status file: `../02.20-validation-status-pe-meta-instruction-design.md`
...
5. Update checkboxes in `../02.20-validation-status-pe-meta-instruction-design.md`.
