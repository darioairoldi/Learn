---
title: "pe-meta-hook-create-update validation runbook"
...
# pe-meta-hook-create-update validation runbook
...
- Path: `C:\dev\darioairoldi\Learn\.github\prompts\00.09-pe-meta\pe-meta-hook-create-update.prompt.md`
- Status file: `../02.16-validation-status-pe-meta-hook-create-update.md`
...
5. Update checkboxes in `../02.16-validation-status-pe-meta-hook-create-update.md`.
