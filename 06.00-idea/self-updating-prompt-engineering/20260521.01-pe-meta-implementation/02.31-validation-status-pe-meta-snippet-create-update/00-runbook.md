---
title: "pe-meta-snippet-create-update validation runbook"
...
# pe-meta-snippet-create-update validation runbook
...
- Path: `C:\dev\darioairoldi\Learn\.github\prompts\00.09-pe-meta\pe-meta-snippet-create-update.prompt.md`
- Status file: `../02.31-validation-status-pe-meta-snippet-create-update.md`
...
5. Update checkboxes in `../02.31-validation-status-pe-meta-snippet-create-update.md`.
