---
title: "pe-meta-template-design validation runbook"
...
# pe-meta-template-design validation runbook
...
- Path: `C:\dev\darioairoldi\Learn\.github\prompts\00.09-pe-meta\pe-meta-template-design.prompt.md`
- Status file: `../02.35-validation-status-pe-meta-template-design.md`
...
5. Update checkboxes in `../02.35-validation-status-pe-meta-template-design.md`.
