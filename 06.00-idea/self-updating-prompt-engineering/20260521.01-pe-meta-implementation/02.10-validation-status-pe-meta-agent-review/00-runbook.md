---
title: "pe-meta-agent-review validation runbook"
...
# pe-meta-agent-review validation runbook
...
- Path: `C:\dev\darioairoldi\Learn\.github\prompts\00.09-pe-meta\pe-meta-agent-review.prompt.md`
- Status file: `../02.10-validation-status-pe-meta-agent-review.md`
...
5. Update checkboxes in `../02.10-validation-status-pe-meta-agent-review.md`.
