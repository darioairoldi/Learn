---
title: "pe-meta-prompt-create-update validation runbook"
...
# pe-meta-prompt-create-update validation runbook
...
- Path: `C:\dev\darioairoldi\Learn\.github\prompts\00.09-pe-meta\pe-meta-prompt-create-update.prompt.md`
- Status file: `../02.22-validation-status-pe-meta-prompt-create-update.md`
...
5. Update checkboxes in `../02.22-validation-status-pe-meta-prompt-create-update.md`.
