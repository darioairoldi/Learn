---
title: "pe-meta-instruction-create-update validation runbook"
...
# pe-meta-instruction-create-update validation runbook
...
- Path: `C:\dev\darioairoldi\Learn\.github\prompts\00.09-pe-meta\pe-meta-instruction-create-update.prompt.md`
- Status file: `../02.19-validation-status-pe-meta-instruction-create-update.md`
...
5. Update checkboxes in `../02.19-validation-status-pe-meta-instruction-create-update.md`.
