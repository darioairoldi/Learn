---
title: "pe-meta-prompt-design validation runbook"
...
# pe-meta-prompt-design validation runbook
...
- Path: `C:\dev\darioairoldi\Learn\.github\prompts\00.09-pe-meta\pe-meta-prompt-design.prompt.md`
- Status file: `../02.23-validation-status-pe-meta-prompt-design.md`
...
5. Update checkboxes in `../02.23-validation-status-pe-meta-prompt-design.md`.
