---
title: "pe-meta-optimizer validation runbook"
...
# pe-meta-optimizer validation runbook
...
- Path: `C:\dev\darioairoldi\Learn\.github\agents\00.09-pe-meta\pe-meta-optimizer.agent.md`
- Status file: `../02.04-validation-status-pe-meta-optimizer.md`
...
5. Update checkboxes in `../02.04-validation-status-pe-meta-optimizer.md`.
