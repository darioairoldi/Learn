---
title: "pe-meta-update validation runbook"
...
# pe-meta-update validation runbook
...
- Path: `C:\dev\darioairoldi\Learn\.github\prompts\00.09-pe-meta\pe-meta-update.prompt.md`
- Status file: `../02.37-validation-status-pe-meta-update.md`
...
5. Update checkboxes in `../02.37-validation-status-pe-meta-update.md`.
