---
title: "pe-meta-instruction-review validation runbook"
...
# pe-meta-instruction-review validation runbook
...
- Path: `C:\dev\darioairoldi\Learn\.github\prompts\00.09-pe-meta\pe-meta-instruction-review.prompt.md`
- Status file: `../02.21-validation-status-pe-meta-instruction-review.md`
...
5. Update checkboxes in `../02.21-validation-status-pe-meta-instruction-review.md`.
