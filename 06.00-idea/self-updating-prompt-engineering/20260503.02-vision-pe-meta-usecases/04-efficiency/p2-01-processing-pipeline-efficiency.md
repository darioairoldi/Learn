...
|---|---|
| `--dim optimize` | Efficiency group including D25 |
| `--dim processing-efficiency` | Focus on D25 specifically |
...
Together, D21+D24+D25 cover all three levels of processing efficiency.
