...
| `D3-token-budget` | structural / optimize / efficiency | [p1-01-token-budget-analysis](p1-01-token-budget-analysis-usecase.md), [p3-02-structural-validation](p3-02-structural-validation-usecase.md) |
...
| `D20-token-chain` | optimize | [p1-01-token-budget-analysis](p1-01-token-budget-analysis-usecase.md) |
| `D21-deterministic-first` | optimize | [p2-04-deterministic-first-optimization](p2-04-deterministic-first-optimization-usecase.md) |
| `D23-reference-efficiency` | optimize | [p2-02-reference-load-efficiency](p2-02-reference-load-efficiency-usecase.md) |
| `D24-handoff-efficiency` | optimize | [p2-03-handoff-efficiency](p2-03-handoff-efficiency-usecase.md) |
