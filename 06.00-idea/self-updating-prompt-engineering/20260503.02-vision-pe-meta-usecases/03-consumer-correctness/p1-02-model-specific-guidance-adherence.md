...
| `--dim model-adherence` | Explicit D27 targeting |
...
Together:               "Is the right model doing the work (D26), and is the work structured
                         for that model's strengths (D27)?"
```

D26 without D27: you have the right model but generic patterns → suboptimal
D27 without D26: you follow Claude patterns but route everything through standard model → wasted patterns
