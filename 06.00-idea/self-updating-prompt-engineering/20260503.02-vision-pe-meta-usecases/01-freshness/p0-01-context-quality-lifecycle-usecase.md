...
|---|---|
| `--dim context-full` | Full context lifecycle dimensions (`D6-consistency` through `D13-source-verification`, `D17-cross-coherence`, `D19-artifact-structure`, `D22-context-optimization`) |
...
| UC-16 (context optimization) | Provides `D22-context-optimization` optimization checks within the broader lifecycle |
