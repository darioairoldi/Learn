...
| Option | Relevance |
|---|---|
| `--dim reliability` | Engages boundary-actionability red-team (`D33-boundary-actionability`) |
...
- [03-consumer-correctness/](../03-consumer-correctness/00-overview.md) — adherence relies on boundaries actually being enforced
