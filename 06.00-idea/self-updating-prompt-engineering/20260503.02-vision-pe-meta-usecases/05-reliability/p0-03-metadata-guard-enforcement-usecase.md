...
| Option | Relevance |
|---|---|
| `--dim reliability` | Engages metadata-guard audit (`D30-metadata-guard`) |
...
- [03-consumer-correctness/p0-01-dependency-aware-full-review](../03-consumer-correctness/p0-01-dependency-aware-full-review-usecase.md) — adherence audit assumes guards are working
