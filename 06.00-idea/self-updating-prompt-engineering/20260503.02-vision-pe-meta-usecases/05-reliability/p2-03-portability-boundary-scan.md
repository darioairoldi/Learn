...
| Option | Relevance |
|---|---|
| `--dim reliability` | Engages portability-boundary scan (D35) |
...
- [p0-03-metadata-guard-enforcement](p0-03-metadata-guard-enforcement.md) — both depend on YAML metadata integrity
- [p2-04-mode-vs-risk-decoupling-check](p2-04-mode-vs-risk-decoupling-check.md) — both audit invariants declared in the vision's option model
