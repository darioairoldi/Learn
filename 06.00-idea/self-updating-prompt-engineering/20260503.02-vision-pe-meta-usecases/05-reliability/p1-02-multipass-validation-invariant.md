...
| Option | Relevance |
|---|---|
| `--dim reliability` | Engages multi-pass invariant check (D31) |
...
D30 (metadata-guard-enforcement) — adjacent (validation entries live in the same log structure).
...
- [p0-03-metadata-guard-enforcement](p0-03-metadata-guard-enforcement.md) — adjacent audit on the same log
- [p2-01-autonomy-calibration-audit](p2-01-autonomy-calibration-audit.md) — uses validation-pass density as a calibration input
- [p0-02-regression-protection](p0-02-regression-protection.md) — regression check is one form of validation pass
