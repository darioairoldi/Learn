...
| Option | Relevance |
|---|---|
| `--dim reliability` | Engages loop-stability scan (D29 loop-stability) |
...
Coordinate with [p2-02-conflict-resolution-coverage](p2-02-conflict-resolution-coverage.md): if oscillation is detected, the missing precedence rule is added there.
...
- [p2-02-conflict-resolution-coverage](p2-02-conflict-resolution-coverage.md) — remediation target for detected oscillations
- [p0-01-process-reproducibility](p0-01-process-reproducibility.md) — different scope: reproducibility is single-input determinism; this UC is multi-run stability
- [p2-01-autonomy-calibration-audit](p2-01-autonomy-calibration-audit.md) — oscillation rate is an input signal for autonomy-threshold tuning
