...
- [p0-02-regression-protection](p0-02-regression-protection.md) — regression check assumes reproducibility holds
- [p1-01-loop-stability-audit](p1-01-loop-stability-audit.md) — different concept: state-trajectory stability across N runs vs. output-equivalence across 2 runs
- [p1-02-multipass-validation-invariant](p1-02-multipass-validation-invariant.md) — multi-pass on changes vs. multi-run on assessments
