...
| Option | Relevance |
|---|---|
| `--dim reliability` | Engages autonomy-calibration audit (D34) |
...
D29 (regression-protection-coverage) — input signal.
...
- [p1-02-multipass-validation-invariant](p1-02-multipass-validation-invariant.md) — invariant must hold before calibration is meaningful
- [p1-04-boundary-actionability-redteam](p1-04-boundary-actionability-redteam.md) — probe failures feed into calibration signal
- [p0-02-regression-protection](p0-02-regression-protection.md) — rollback rate is a primary calibration input
