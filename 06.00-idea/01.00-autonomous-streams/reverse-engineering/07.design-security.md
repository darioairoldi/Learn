...
2. [Information Disclosure Model](#information-disclosure-model)
3. [Source Artifacts to Read](#source-artifacts-to-read)
4. [Security Overview Page](#security-overview-page)
5. [Security Posture Page](#security-posture-page)
6. [Internal Security Detail File](#internal-security-detail-file)
7. [Legacy Compatibility Classification](#legacy-compatibility-classification)
...
3. **Per-component access control** — table showing which components require which auth:
   ...
   | Admin tool BFF | Yes | {scheme} | None |
   | CertChecker Function | N/A | Managed identity | Internal trigger |
