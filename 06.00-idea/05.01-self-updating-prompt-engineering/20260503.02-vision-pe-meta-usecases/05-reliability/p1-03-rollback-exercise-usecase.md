...
| Option | Relevance |
|---|---|
| `--dim reliability` | Engages rollback-readiness check (`D32-rollback-readiness`) |
...
- [p2-01-autonomy-calibration-audit](p2-01-autonomy-calibration-audit-usecase.md) — drill failure rate factors into autonomy-threshold calibration
