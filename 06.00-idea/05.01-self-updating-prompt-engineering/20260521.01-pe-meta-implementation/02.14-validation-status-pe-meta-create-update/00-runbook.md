---
title: "pe-meta-create-update validation runbook"
...
# pe-meta-create-update validation runbook
...
- Path: `C:\dev\darioairoldi\Learn\.github\prompts\00.09-pe-meta\pe-meta-create-update.prompt.md`
- Status file: `../02.14-validation-status-pe-meta-create-update.md`
...
5. Update checkboxes in `../02.14-validation-status-pe-meta-create-update.md`.
