---
title: "pe-meta-agent-create-update validation runbook"
...
# pe-meta-agent-create-update validation runbook
...
- Path: `C:\dev\darioairoldi\Learn\.github\prompts\00.09-pe-meta\pe-meta-agent-create-update.prompt.md`
- Status file: `../02.08-validation-status-pe-meta-agent-create-update.md`
...
5. Update checkboxes in `../02.08-validation-status-pe-meta-agent-create-update.md`.
