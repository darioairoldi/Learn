---
title: "pe-meta-template-review validation runbook"
...
# pe-meta-template-review validation runbook
...
- Path: `C:\dev\darioairoldi\Learn\.github\prompts\00.09-pe-meta\pe-meta-template-review.prompt.md`
- Status file: `../02.36-validation-status-pe-meta-template-review.md`
...
5. Update checkboxes in `../02.36-validation-status-pe-meta-template-review.md`.
