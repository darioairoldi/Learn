...
3. [Architecture Overview Page](#architecture-overview-page)
4. [Logical Architecture Page](#logical-architecture-page)
5. [Project Structure Page](#project-structure-page)
6. [Diagram Criteria](#diagram-criteria)
...
- Use Mermaid subgraph labels that match actual assembly names (e.g., `MicroserviceA.Api`)
