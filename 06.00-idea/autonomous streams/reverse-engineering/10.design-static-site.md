...
0. [SSG tool detection and selection](#ssg-tool-detection-and-selection)
1. [Purpose and scope](#purpose-and-scope)
2. [Repository layout for the site](#repository-layout-for-the-site)
3. [mkdocs.yml — authoritative configuration (MkDocs)](#mkdocsyml--authoritative-configuration-mkdocs)
   - [3b. _quarto.yml — authoritative configuration (Quarto)](#b-quartoyml--authoritative-configuration-quarto)
4. [Mermaid diagram support](#mermaid-diagram-support)
5. [Images and site assets](#images-and-site-assets)
6. [Branding and theming](#branding-and-theming)
7. [Authentication and authorization](#authentication-and-authorization)
8. [Build procedure](#build-procedure)
9. [Deployment pipeline](#deployment-pipeline)
10. [Manual deployment procedure](#manual-deployment-procedure)
11. [Agent guidance — generating the site](#agent-guidance--generating-the-site)
...
The build procedure depends on which SSG is active (see [Section 0 — tool detection](#ssg-tool-detection-and-selection)). Both tools produce the same output directory structure that the pipeline and the Azure SWA deployment expect.
