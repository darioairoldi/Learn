...
- Cross-reference `.copilot/context/prompt-engineering/tool-composition-guide.md`
...
1. `.copilot/context/prompt-engineering/context-engineering-principles.md`
2. `.copilot/context/prompt-engineering/tool-composition-guide.md`
