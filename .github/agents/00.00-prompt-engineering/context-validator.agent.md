...
|---|---|---|---|
| 1 | **Title** | H1 heading present, matches filename topic | HIGH |
| 2 | **Purpose statement** | `**Purpose**:` present within first 5 lines | CRITICAL |
| 3 | **Referenced by** | Section present listing known consumers | HIGH |
| 4 | **Core content** | At least one substantive section with rules/patterns | CRITICAL |
| 5 | **References** | External and internal references section present | MEDIUM |
| 6 | **Version history** | Version/date metadata in HTML comment at end | MEDIUM |

### Content Quality Checks

| # | Check | Criteria | Severity |
|---|---|---|---|
| 7 | **Imperative language** | Uses MUST, WILL, NEVER — not suggestions | HIGH |
| 8 | **Clarity** | Rules are unambiguous — no "consider" or "might want to" | HIGH |
| 9 | **Priority ordering** | Most critical rules appear in first sections (early commands) | MEDIUM |
| 10 | **No embedded examples** | Examples from THIS repository, not generic | MEDIUM |
| 11 | **Actionability** | Each rule tells an agent what to DO, not just what to know | HIGH |

### Integrity Checks

| # | Check | Criteria | Severity |
|---|---|---|---|
| 12 | **Token budget** | File =2,500 tokens (~375 lines) | CRITICAL |
| 13 | **No duplication** | Content not duplicated in other context files (`grep_search` key phrases) | CRITICAL |
| 14 | **No contradictions** | Rules don't conflict with other context files or instructions | CRITICAL |
| 15 | **Cross-references resolve** | All `📖` links and file references point to existing files | HIGH |
| 16 | **No circular references** | File doesn't reference itself or create circular dependency chains | HIGH |
| 17 | **Consumer compatibility** | Changes don't break agents/prompts that reference this file | CRITICAL |

### Efficiency Checks

| # | Check | Criteria | Severity |
|---|---|---|---|
| 18 | **No verbose prose** | Tables and lists preferred over paragraphs for rules | MEDIUM |
| 19 | **Template externalization** | Output formats >10 lines externalized to templates | MEDIUM |
| 20 | **Reference density** | Context files reference, not embed, content from other files | HIGH |
