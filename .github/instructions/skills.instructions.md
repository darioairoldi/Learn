...
**Key principles for skills** (see context file for full details):
...
**📖 Complete guidance:** [.copilot/context/prompt-engineering/progressive-disclosure-pattern.md](../../.copilot/context/prompt-engineering/progressive-disclosure-pattern.md)
