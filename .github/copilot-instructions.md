...
4. **Dual Metadata System** (Critical Pattern)
   ...
   - See `.copilot/context/dual-yaml-helpers.md` for complete guidelines
...
- [.copilot/context/dual-yaml-helpers.md](.copilot/context/dual-yaml-helpers.md) - Metadata parsing rules
