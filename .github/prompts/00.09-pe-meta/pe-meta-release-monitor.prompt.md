...
2. **Map to affected PE artifact types** using the governance baseline (`00.01-governance-and-capability-baseline.md`) and the `dependency-tracking` file (see 00.00-context-structure-index.md → Functional Categories in `.copilot/context/00.00-prompt-engineering/`)
